...
- In practice, the choice of expert functions rely on the following considerations:
  ...
  - **Computational Efficiency**: Sometimes it may be worthwhile to sacrifice some fitting performance
